...
export class InitialSchema1762354546754 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "food_levels" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "device_id" uuid NOT NULL, "level" integer NOT NULL, "estimated_days_left" integer, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_646bfaf8d9dec5f529507d4ac43" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_type_enum" AS ENUM('FEEDING_SUCCESS', 'FEEDING_FAILED', 'LOW_FOOD_LEVEL', 'DEVICE_OFFLINE', 'DEVICE_ONLINE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."pets_species_enum" AS ENUM('cat', 'dog', 'other')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "feeding_events" ADD CONSTRAINT "FK_4733999aa1af92e23464b23e0fe" FOREIGN KEY ("device_id") REFERENCES "devices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "feeding_events" ADD CONSTRAINT "FK_1654e6e4a30393591e1de226129" FOREIGN KEY ("pet_id") REFERENCES "pets"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "feeding_events" ADD CONSTRAINT "FK_c39f2d5bf15136b9f5959b19429" FOREIGN KEY ("schedule_id") REFERENCES "schedules"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "schedules" ADD CONSTRAINT "FK_249663b434d4a5303673c34edaa" FOREIGN KEY ("device_id") REFERENCES "devices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "food_levels" ADD CONSTRAINT "FK_5eba9a8fa75a65aca1b9b082178" FOREIGN KEY ("device_id") REFERENCES "devices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD CONSTRAINT "FK_9a8a82462cab47c73d25f49261f" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ADD CONSTRAINT "FK_49291f4397a09af4eae014d7d07" FOREIGN KEY ("device_id") REFERENCES "devices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "devices" ADD CONSTRAINT "FK_bd378ace1af20893f64035a07f2" FOREIGN KEY ("pet_id") REFERENCES "pets"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "pets" ADD CONSTRAINT "FK_4ddf2615c9d24b5be6d26830b4b" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "devices" DROP CONSTRAINT "FK_bd378ace1af20893f64035a07f2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "devices" DROP CONSTRAINT "FK_5e9bee993b4ce35c3606cda194c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" DROP CONSTRAINT "FK_49291f4397a09af4eae014d7d07"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" DROP CONSTRAINT "FK_9a8a82462cab47c73d25f49261f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "food_levels" DROP CONSTRAINT "FK_5eba9a8fa75a65aca1b9b082178"`,
    );
    await queryRunner.query(
      `ALTER TABLE "schedules" DROP CONSTRAINT "FK_249663b434d4a5303673c34edaa"`,
    );
    await queryRunner.query(
      `ALTER TABLE "feeding_events" DROP CONSTRAINT "FK_c39f2d5bf15136b9f5959b19429"`,
    );
    await queryRunner.query(
      `ALTER TABLE "feeding_events" DROP CONSTRAINT "FK_1654e6e4a30393591e1de226129"`,
    );
    await queryRunner.query(
      `ALTER TABLE "feeding_events" DROP CONSTRAINT "FK_4733999aa1af92e23464b23e0fe"`,
    );
